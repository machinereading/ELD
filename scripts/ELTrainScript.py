...
from src.utils import TimeUtil, jsonload
...
module = EL("train", "old_candidates_wiki")
train_set = []
dev_set = []
test_set = []
c = 1

train_set = [x for x in jsonload("corpus/el_wiki/wiki_cwform_train.json")]
dev_set = [x for x in jsonload("corpus/el_wiki/wiki_cwform_dev.json")]
